    ...
    <div style={{ paddingTop: 68 }}>
      ...
      <section style={{ background: 'var(--ink)', color: 'white', padding: '72px 24px 56px', textAlign: 'center' }}>
        <div style={{ maxWidth: 640, margin: '0 auto' }}>
          ...
          <Anim delay={0.2}><p style={{ fontSize: 16, color: 'rgba(255,255,255,0.55)', lineHeight: 1.7 }}>We're launching in Siliguri first. Sign up early and be among the first to access the platform — whether you need workers or you are one.</p></Anim>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 560, margin: '0 auto' }}>
                ...
                <div style={{ background: 'white', borderRadius: 20, padding: '32px', border: '1px solid rgba(0,0,0,0.08)', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
                  {tab === 'customer' ? (
                    <form onSubmit={handleSubmit}>
                      ...
                      <Input label="City" placeholder="e.g. Siliguri" value={cCity} onChange={e => setCCity(e.target.value)} required />
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <Input label="City" placeholder="e.g. Siliguri" value={wCity} onChange={e => setWCity(e.target.value)} required />
          ...
          <Anim delay={0.2} style={{ marginTop: 48, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            {[
              ...
              { icon: '📍', label: 'Location', value: 'Siliguri, WB, India' },
