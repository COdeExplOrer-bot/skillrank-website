...
export default function HowItWorks({ navigate }) {
  ...
  const faqs = [
    ...
    { q: 'Is SkillRank available in my city?', a: 'We are launching in Kolkata, West Bengal first. Join the waitlist and we will notify you when we expand to your city.' },
