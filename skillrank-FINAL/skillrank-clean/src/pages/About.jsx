...
const team = [
  { initials: 'F', name: 'Founder', role: 'CEO & Product', location: 'Kolkata, WB', color: '#2952C4' },
  { initials: 'C', name: 'Co-Founder', role: 'Technology', location: 'Kolkata, WB', color: '#0A7A55' },
  { initials: 'C', name: 'Co-Founder', role: 'Operations', location: 'Kolkata, WB', color: '#E8420A' },
]
      ...
      <section style={{ padding: '80px 24px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <Anim style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2 style={{ fontSize: 'clamp(28px,4vw,42px)', fontWeight: 800 }}>Built in Kolkata, for India</h2>
