...
export const WORKERS = [
  ...
  { id: 'w3', name: 'Sunil Das', initials: 'SD', skill: 'Painter', exp: '10 yrs', rating: 4.6, jobs: 241, completion: 91, repeat: 61, rank: 'Gold', rankColor: '#B07A00', rankBg: '#FEF3D7', distance: 3.4, online: true, color: '#8A3FC8', skills: ['Interior','Exterior','Texture','Waterproofing'], reviews: [{ text: 'Best painter in Siliguri. Clean finish.', by: 'Kavya R.' }] },
